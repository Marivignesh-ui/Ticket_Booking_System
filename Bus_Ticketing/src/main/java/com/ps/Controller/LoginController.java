...
import com.ps.domain.WebResponse;
import com.ps.services.LoginService;
import com.ps.util.HashUtil;
...
public class LoginController extends HttpServlet{
    ...
    public void doPost(HttpServletRequest req,HttpServletResponse res)throws IOException{
        try{
            ...
            logger.debug("User returnde from DB: "+user+" Given hashedpassword: "+hashedPassword+"User pass:"+user.getHashedPassword());
